    ...
    <section className="flex flex-col lg:flex-row items-center lg:justify-between w-full lg:w-4/5 mx-auto">
      <div className="my-20 px-5">
        ...
        <Link
          to="/products"
          type="button"
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-base px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 dark:text-gray-200 tracking-wider"
        >
          Explore eBooks
        </Link>
      </div>
      <div className="visual my-20 px-5 ">
        <img
