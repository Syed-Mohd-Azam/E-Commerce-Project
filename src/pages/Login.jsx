      ...
      <section className="flex-1 w-4/5 mx-auto  text-center italic font-bold text-2xl text-blue-900 dark:text-slate-200 py-5 ">
        ...
        <form>
          ...
          <div className="my-10 mx-3 text-left">
            <button className="text-[20px] dark:hover:bg-blue-900 dark:hover:text-slate-200 p-2 px-3 rounded-md dark:bg-slate-200 dark:text-sky-900 bg-blue-900 text-white hover:scale-110">
              Login as User
            </button>
          </div>
        </form>
