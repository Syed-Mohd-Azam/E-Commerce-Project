        ...
        <form>
          ...
          <div className="m-4 flex flex-col">
            ...
            <input
              ...
              className="block dark:bg-slate-200 rounded-sm italic bg-blue-800 dark:text-blue-900 text-slate-200 py-1 px-2 text-md font-semibold"
            />
          </div>
          <div className="my-10 mx-3 text-left">
            <button className="text-[20px] dark:hover:bg-sky-900 dark:hover:text-slate-200 p-2 px-3 rounded-md dark:bg-slate-200 dark:text-sky-900 bg-blue-800 text-white hover:scale-110">
              Login as User
            </button>
          </div>
        </form>
