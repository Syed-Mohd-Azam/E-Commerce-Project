    ...
    <>
      <section className=" h-auto w-4/5 lg:w-[300px]  rounded-xl relative">
        ...
        <article className=" w-full  h-[200px]">
          <img
            className="w-full h-full dark:text-gray-200 rounded-lg shadow-lg hover:cursor-pointer"
            // eslint-disable-next-line react/prop-types
        ...
        <article className="h-auto py-1 px-2">
          ...
          <article className="flex justify-end items-center py-1">
            <p className="font-bold italic text-xl text-blue-900 dark;text-gray-200 dark:text-white px-5">
              {product?.price}$
            </p>
          </article>
          <article className="flex flex-row justify-between items-center py-3">
            {product?.best_seller && (
              <p className=" dark:bg-gray-200  font-bold py-2 px-5 rounded-md dark:text-blue-900 bg-blue-900 text-white">
                Best Seller
              </p>
            )}
            {!product?.best_seller && (
